...
export function AppShell() {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7787/ingest/85325ec4-61eb-48fe-9ac8-a4df78cb3f3d',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'ea7dae'},body:JSON.stringify({sessionId:'ea7dae',runId:'pre-fix',hypothesisId:'B',location:'AppShell.tsx:AppShell',message:'AppShell render',data:{},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
